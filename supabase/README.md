...
8. **`20250114_fix_debt_amount_ambiguous.sql`** — исправление ambiguous `amount` при увеличении; смена счёта при редактировании
9. **`20250115_debt_initial_entry.sql`** — первоначальный займ в истории долга
10. **`20250116_fix_debt_stats.sql`** — исправление сводки «Мне должны / Я должен»
11. **`20250117_execute_scheduled_overrides.sql`** — правка суммы/даты при «Выполнить сейчас»
